    ...
    <div class="mx-auto max-w-6xl px-5 py-6">
      <header class="mb-5 flex items-center gap-4">
        ...
        <p class="max-w-2xl text-sm text-zinc-600">
          Antibody and TCR variable-domain recognition and IMGT numbering, running in a
          configurable pool of dedicated workers. Sequences never leave this tab.
        </p>
      </header>
      ...
      <div class="grid items-start gap-5 lg:grid-cols-[21rem_1fr]">
        <section class={`${PANEL} space-y-4`}>
          ...
          <Field
            ...
            hint="Nothing selected means every species."
          >
            <select
              id="species"
              multiple
              ...
              onChange={(event) => {
                patch({
                  species: [...event.currentTarget.selectedOptions].map(
                    (option) => option.value,
                  ),
                });
              }}
